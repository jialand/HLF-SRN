...
parser.add_argument('--data_train', type=str, default='FFHQ', help='train dataset name')
...
parser.add_argument('--dataset_root', type=str, default="X:\\FSR\\SISN-Face-Hallucination-main\\dataset\\FFHQ")
parser.add_argument('--valid_div', type=int, default=30)
...
parser.add_argument('--decay', type=str, default='30-60-90', help='learning rate decay type')
